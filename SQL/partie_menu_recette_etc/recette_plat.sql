...
(9, 'Oeuf au plat 2', 'faire chauffer blablabla....', 36, 0, 1),
(10, 'Carottes râpées', 'Prends les carottes et râpe-les, puis mets la sauce vinaigrette\r\n        ', 36, 0, 1);
...
--
ALTER TABLE `recette_plat`
  MODIFY `Id_Recette` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;COMMIT;
